...
@section('title', 'Schedule of Individual Interest Contribution')
...
<div class="space-y-8">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl font-bold text-white drop-shadow">Schedule of Individual Interest Contribution</h1>
                </div>
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.reports.schedule.interest-contribution.export', ['year' => $year]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-sm font-semibold rounded-xl shadow">
    ...
    <div class="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-blue-100 overflow-hidden print:shadow-none">
        <div class="p-6 print:p-4">
            ...
            <h3 class="text-center font-bold text-blue-900 text-xl mb-2 tracking-wide">SCHEDULE OF INDIVIDUAL INTEREST CONTRIBUTION - {{ $year }}</h3>
            @if($blocks->isEmpty())
            <div class="text-center py-12 text-blue-400">No dividend/interest contribution data for {{ $year }}. Calculate dividends first.</div>
            @else
