...
@section('title', 'Monthly Schedule of Mortuary Aid')
...
<div class="space-y-8">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl font-bold text-white drop-shadow">Monthly Schedule of Mortuary Aid</h1>
                </div>
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.reports.schedule.monthly-mortuary-aid.export', ['year' => $year]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-sm font-semibold rounded-xl shadow">
    ...
    <div class="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-blue-100 overflow-hidden print:shadow-none">
        <div class="p-6 print:p-4 overflow-x-auto">
            ...
            <h3 class="text-center font-bold text-blue-900 text-xl mb-4 tracking-wide">MONTHLY SCHEDULE OF MORTUARY AID - {{ $year }}</h3>

            @if($members->isEmpty())
            <div class="text-center py-12 text-blue-400">No mortuary aid data for {{ $year }}. Add contributions with type "Mortuary" first.</div>
            @else
            <table class="w-full border-collapse border border-blue-200 text-sm min-w-[800px] bg-white/90">
                <thead>
                    <tr class="bg-blue-100">
                        ...
                        <th class="border border-blue-200 px-2 py-1.5 text-right font-semibold text-blue-900">JUNE</th>
                        <th class="border border-blue-200 px-2 py-1.5 text-right font-semibold text-blue-900">JULY</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-blue-100 font-bold">
                        <td colspan="2" class="border border-blue-200 px-2 py-1.5 text-blue-900">GRAND TOTAL</td>
                        @for($mo = 1; $mo <= 12; $mo++)
