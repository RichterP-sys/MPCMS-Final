...
@section('title', 'Schedule of Mortuary Aid Individual Contribution')
...
<div class="space-y-8">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl font-bold text-white drop-shadow">Schedule of Mortuary Aid Individual Contribution</h1>
                </div>
                <p class="text-white/90 font-medium">As of Dec. <span class="font-bold">{{ $year }}</span></p>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.reports.schedule.mortuary-aid.export', ['year' => $year]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-sm font-semibold rounded-xl shadow">
    ...
    <div class="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-blue-100 overflow-hidden print:shadow-none">
        <div class="p-6 print:p-4">
            ...
            <h3 class="text-center font-bold text-blue-900 text-xl mb-2 tracking-wide">SCHEDULE OF MORTUARY AID INDIVIDUAL CONTRIBUTION</h3>
            <p class="text-center text-sm text-blue-700 mb-4">As of Dec. <span class="font-semibold">{{ $year }}</span></p>
            @if($blocks->isEmpty())
            <div class="text-center py-12 text-blue-400">No mortuary aid contribution data for {{ $year }}. Add contributions with type "Mortuary" first.</div>
            @else
