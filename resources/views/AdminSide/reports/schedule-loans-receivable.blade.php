...
@section('title', 'Schedule of Loan Receivables')
...
<div class="space-y-8">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl font-bold text-white drop-shadow">Schedule of Loan Receivables</h1>
                </div>
                <p class="text-white/90 font-medium">For the Year Ended December 31, <span class="font-bold">{{ $year }}</span></p>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.reports.schedule.loans-receivable.export', ['year' => $year]) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-sm font-semibold rounded-xl shadow">
    ...
    <div class="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-blue-100 overflow-hidden print:shadow-none">
        <div class="p-6 print:p-4">
            ...
            <h3 class="text-center font-bold text-blue-900 text-xl mb-2 tracking-wide">SCHEDULE OF LOAN RECEIVABLES</h3>
            <p class="text-center text-sm text-blue-700 mb-4">For the Year Ended December 31, <span class="font-semibold">{{ $year }}</span></p>
            @if(!$blocks->isEmpty())
            ...
            @if($blocks->isEmpty())
            <div class="text-center py-12 text-blue-400">No outstanding loan receivables.</div>
            @else
